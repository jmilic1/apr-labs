...
type Function struct {
	...
	Hess      func(point *Point) *internal.Matrix
	Jacob     func(point *Point) *internal.Matrix
	NonLinear func(point *Point) *internal.Matrix
}
...
func FunctionOne() *Function {
	...
	fu.Hess = func(point *Point) *internal.Matrix {
		x1 := point.DimensionVals[0]
		x2 := point.DimensionVals[1]
		...
		return internal.NewMatrixFromArray(mat)
	}
